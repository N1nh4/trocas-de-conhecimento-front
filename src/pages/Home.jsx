    ...
    <div className="flex flex-col min-h-screen font-sans text-slate-800 bg-[#f8fafc]">
      ...
      <nav className="flex items-center justify-between px-10 py-4 bg-white/70 backdrop-blur-md sticky top-0 z-50 border-b border-white/20 shadow-sm">
        ...
        <div className="flex items-center gap-8 text-sm font-semibold text-slate-600">
          ...
          <Link to="/cadastro" className="hover:text-teal-600 transition">Cadastrar-se</Link>
          <Link to="/listagem" className="hover:text-teal-600 transition">Conhecimentos</Link>
          {/* Botão do menu ajustado para o laranja #ea7b0c consistente com o CTA */}
          <button className="bg-[#ea7b0c] text-white px-5 py-2.5 rounded-xl hover:bg-[#d46d0a] transition shadow-lg shadow-orange-900/20 text-xs font-bold uppercase tracking-wider">
      ...
      <section className="relative bg-gradient-to-tr from-[#0d9488] via-[#1a9a9b] to-[#2563eb] py-32 px-6 text-center text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <Link to="/listagem" className="bg-white text-teal-700 px-10 py-4 rounded-2xl font-bold hover:shadow-2xl transition-all hover:-translate-y-1 shadow-xl hover:bg-[#ea7b0c] hover:text-white">
              Explorar conhecimentos <span>→</span>
            </Link>
            <button className="bg-white/10 border border-white/30 text-white px-10 py-4 rounded-2xl font-bold backdrop-blur-md hover:bg-white/20 transition-all">
